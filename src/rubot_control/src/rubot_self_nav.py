...
#Nomes mira cap endavant (cap endarrera es complicaria i s'hauria de girar en sentit contari)
        #if closestDistance < self._distanceLaser and -90 < (angleClosestDistance) < 90:
        #canviem l'orientació d'observació del sistema, doncs hem dinat la volta al LIDAR
        if closestDistance < self._distanceLaser and 90 < (angleClosestDistance) < -90:
